...
_RAW_CITYSCAPES_SPLITS = {
    ...
    "cityscapes_foggy_train": ("leftImg8bit_trainvaltest_foggy/leftImg8bit_foggy/train/", "gtFine/train/"),
    # "cityscapes_foggy_val": ("cityscape_foggy/leftImg8bit/val/", "cityscape_foggy/gtFine/val/"),
    "cityscapes_foggy_val": ("leftImg8bit_trainvaltest_foggy/leftImg8bit_foggy/val/", "gtFine/val/"),
    # "cityscapes_foggy_test": ("cityscape_foggy/leftImg8bit/test/", "cityscape_foggy/gtFine/test/"),
    "cityscapes_foggy_test": ("leftImg8bit_trainvaltest_foggy/leftImg8bit_foggy/test", "gtFine/test/"),
}


def register_all_cityscapes_foggy(root):
    root = "D:/adaptive_teacher/datasets/"
